...
import type { BoardConfig, CutPiece, NormalizedPiece, PackingResult } from '../lib/packing'
...
export function useDebouncedPacking(args: {
  ...
  const { board, cuts, globalRotationDefault, debounceMs = 200, maxPlacements = 5000 } = args
  ...
  }, [board, debounceMs, maxPlacements, normalizedPieces])
